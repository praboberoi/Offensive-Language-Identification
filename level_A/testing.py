...
def main():
    ...
    with open("./logistic_regression/level_A/count_vectorizer.pkl", "rb") as f:
    ...
    model.load_state_dict(torch.load("./logistic_regression/level_A/logistic_regression_model.pt"))

    # Load the test TSV file
    test_data = pd.read_csv("./dev_a.tsv", sep="\t", header=None, names=["text", "Previous_predict"])
    ...
    test_data.to_csv("./logistic_regression/level_A/output_file.tsv", sep="\t", index=False)
