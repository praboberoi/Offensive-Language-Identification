...
def main():
    data = load_data('./formated_file_a.tsv')
    ...
    with open('./feed_forward/level_A/scores.txt', 'a') as f:
        f.write('XXXXXXXXXXXXXXXXXXTestingScoreXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n')
        f.write(f"Accuracy: {100 * correct / total:.2f}%\n")
        f.write(f"F1 Score: {f1:.4f}\n")

    fasttext_model.save("./feed_forward/level_A/fasttext_model.bin")
    torch.save(model.state_dict(), "./feed_forward/level_A/logistic_regression_model.pt")
